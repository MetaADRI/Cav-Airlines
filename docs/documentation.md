# CAVAIR Web Application Documentation

## Introduction & Purpose
CAVAIR (CAV-Zambia Airlines Reservation System) is a modern web application for airline booking, management, and administration. It is designed for passengers and airline staff to provide a seamless digital experience for Zambia’s air travel market.
...
1. **Home Page**: 3+ images (GIF, JPEG, PNG), auto-loading video, social media links (Facebook, Twitter, etc.), flight schedules, and text content.
...
## Main Features
### Home Page
- Rotating carousel of 3+ images (GIF, JPEG, PNG)
...
- Analytics/reporting (basic stats)
...
- Developed by Group 2 (CAVAIR Team)
- Uses open-source libraries: Bootstrap, jQuery, Font Awesome, Google Maps API
- Special thanks to course instructors and contributors

---

This documentation reflects the actual structure and features of the CAVAIR project as implemented in the codebase.
