...
// Parallax background gradieent movement helper function
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  setTodayDate('flight-status-date');
...
// Deals carousel functionality code block
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateCarousel() {
    cards.forEach((card, idx) => {
      ...
      if (card.classList.contains('active') || card.classList.contains('left') || card.classList.contains('far-left')) {
